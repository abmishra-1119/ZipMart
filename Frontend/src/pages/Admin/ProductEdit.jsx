// components/admin/ProductEdit.jsx
...
const ProductEdit = () => {
    ...
    useEffect(() => {
        if (product) {
            ...
            setThumbnail(typeof product.thumbnail === 'string' ? product.thumbnail : '');
    ...
    const handleImageUpload = async (options) => {
        ...
        // Add to new images list for form data
    ...
    const handleRemoveImage = (file) => {
        if (file.type === 'new') {
            ...
            // Add to removed images list for backend
    ...
    const onFinish = async (values) => {
        try {
            ...
            // Add thumbnail if it's a valid URL or empty string
            ...
            await dispatch(adminUpdateProduct({
                productId,
                                ...
                                <Row gutter={[16, 0]}>
                                    ...
                                    <Col xs={24} md={12}>
                                        <Form.Item label="Seller">
                                            <Input
                                                value={product.sellerId?.name || 'N/A'}
                                                disabled
                                            />
                                        </Form.Item>
                                    </Col>
                    ...
                    <Col xs={24} lg={8}>
                        <Card title="Product Images" className="mb-6">
                            ...
                            {thumbnail && isValidUrl(thumbnail) && (
                                <div className="mb-4">
                                    <div className="text-sm text-gray-500 mb-2">Thumbnail Preview:</div>
                                    <Image
                                        src={thumbnail}
                            ...
                            <Form.Item label="Upload Images">
                                ...
                                <div className="text-sm text-gray-500 mt-2">
                                    ...
                                    <div className="mt-1">
                                        ...
                                        <Tag color="green" className="ml-2">Existing</Tag> Current product images
                                    </div>
                                </div>
                            </Form.Item>
                                ...
                                <Alert
                                    ...
                                    description={
                                        <div>
                                            ...
                                            <p>• Removing existing images will delete them from Cloudinary</p>
                                        </div>
                                    }
                                    type="info"
                                    showIcon
                            ...
                            <Card title="Product Metadata" className="mt-6">
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-mono text-xs">{product.sellerId?._id}</span>
                                    </div>
                                </div>
                            </Card>
                        )}
