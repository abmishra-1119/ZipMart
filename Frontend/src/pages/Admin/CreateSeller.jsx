          ...
          {createdSeller && (
            <Card className="max-w-md mx-auto mb-6">
              <div className="text-left space-y-2">
                <p>
                  <strong>Name:</strong> {createdSeller.name}
                </p>
                <p>
                  <strong>Email:</strong> {createdSeller.email}
                </p>
                <p>
                  <strong>Store:</strong> {createdSeller.storeName}
                </p>
                <p>
                  <strong>Role:</strong>{" "}
                  <span className="capitalize">{createdSeller.role}</span>
                </p>
                <p>
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} md={8}>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Secure login credentials</p>
            </div>
          </Col>
        </Row>
      </Card>
