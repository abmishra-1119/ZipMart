...
const SellersManagement = () => {
    ...
    const filteredSellers = sellers.filter(seller => {
        return seller.name?.toLowerCase().includes(searchText.toLowerCase()) ||
            ...
            >
                {sellerToDelete && (
                    <div>
                        ...
                        <p className="font-semibold text-lg mt-2">"{sellerToDelete.name}"?</p>
                        <p className="text-red-500 mt-2">
                            This will permanently remove the seller account and all associated data.
                        </p>
                    </div>
                )}
            </Modal>
