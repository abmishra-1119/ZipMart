// pages/seller/ProductsManagement.jsx
...
import { getMyProducts, deleteMyProduct } from '../../features/seller/sellerSlice';
...
const ProductsManagement = () => {
    ...
    const { products, isLoading, isSuccess, message: sellerMessage } = useSelector(state => state.seller);
