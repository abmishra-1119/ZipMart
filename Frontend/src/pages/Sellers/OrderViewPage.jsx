    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <Space>
                    <Tag color={getStatusColor(order.status)} className="text-lg px-4 py-1">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <Select
                                    ...
                                    disabled={updatingStatus || getStatusOptions(order.status).length === 0}
                                >
                    ...
                    <Card title="Order Summary" className="mb-6">
                        <Row gutter={[16, 16]}>
                            ...
                            <Col xs={12} sm={6}>
                                <Statistic
                                    title="Items"
                                    value={order?.products?.reduce((sum, item) => sum + item.count, 0)}
                                />
                            </Col>
                            <Col xs={12} sm={6}>
                                <Statistic
                        ...
                        <Descriptions bordered column={1} size="small">
                            ...
                            <Descriptions.Item label="Customer Since">
                                {order.user?.createdAt ?
                                    new Date(order.user.createdAt).toLocaleDateString() : 'N/A'
                                }
                            </Descriptions.Item>
                        </Descriptions>
                    </Card>
            ...
            <Card className="mt-6">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-600">Contact support if you need assistance</p>
                    </div>
                    <Space>
