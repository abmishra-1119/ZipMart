      ...
      <div className="container mx-auto px-4">
                    ...
                    >
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.className =
                            "w-full h-full object-scale-down rounded bg-gray-50";
                        }}
                      />
                    </div>
                  ))}
            ...
            <Card className="shadow-sm">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <Rate value={product.totalRating} disabled allowHalf />
        ...
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} lg={12}>
            {/* Existing Reviews */}
            <Card
              title={`Customer Reviews (${product.ratings?.length || 0})`}
              className="shadow-sm"
            >
                    ...
                    <div key={index} className="border-b pb-4 last:border-b-0">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          ...
                          <Rate value={ratingItem.star} disabled size="small" />
                        </div>
