...
const OrderDetailsPage = () => {
  ...
  const getRefundStatusSteps = (order) => {
    if (!order || !isRefundablePayment(order)) return null;

    const steps = [
      {
        title: "Refund Initiated",
        description: "Refund request has been received",
        status: "finish",
        icon: <DollarOutlined />,
      },
    ];

    if (order.refundProcess === "processing") {
      steps.push(
        {
          title: "Processing",
          description: order.refundMsg || "Refund is being processed",
          status: "process",
    ...
    } else if (order.refundProcess === "completed") {
      steps.push(
        {
          title: "Processing",
        ...
        {
          title: "Completed",
          description: "Refund has been credited to your account",
          status: "finish",
          icon: <CheckOutlined />,
        }
      );
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">Order #{currentOrder._id}</p>
            </div>
        ...
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} lg={8}>
            <div className="space-y-6">
              ...
              {/* Refund Status */}
              {isRefundablePayment(currentOrder) && (
                <div className="shadow-sm">
                  <Card
                    title="Refund Status"
                  ...
                  >
                    <Steps
                      direction="vertical"
                      current={
                        currentOrder.refundProcess === "processing" ? 1 : 2
                      }
                      items={getRefundStatusSteps(currentOrder)}
                      size="small"
                    />

                    {currentOrder.refundMsg && (
                      <Alert
                        message="Refund Information"
                        description={currentOrder.refundMsg}
                        type="info"
                        showIcon
                        className="mt-4"
                      />
                    ...
                    <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-xs text-gray-500 mt-2">
                        This amount will be refunded to your original payment
                        method
                      </div>
                    </div>
                  </Card>
                  ...
                  <Descriptions.Item label="Status">
                    ...
                    {isRefundablePayment(currentOrder) && (
                      <Tag color="purple" className="ml-2">
                        Refund {currentOrder.refundProcess || "initiated"}
                      </Tag>
                    )}
                  </Descriptions.Item>
                  ...
                  <Descriptions.Item label="Total Amount">
                    ...
                    {isRefundablePayment(currentOrder) && (
                      <div className="text-sm text-gray-600 mt-1">
                        ...
                        Refund amount: ₹{currentOrder.finalPrice}
                      </div>
                    )}
                  </Descriptions.Item>
                </Descriptions>
                ...
                <div className="text-lg">
                  ...
                  {currentOrder.address.landmark && (
                    <p className="text-gray-600">
                      Near {currentOrder.address.landmark}
                    </p>
                  )}
                  <p className="text-gray-700">
          ...
          {currentOrder && (
            <div className="space-y-4">
              <Alert
                ...
                description={
                  currentOrder.paymentMethod !== "COD"
                    ? "Your payment will be refunded to your original payment method within 7-10 business days."
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p>
                  <strong>Total Amount:</strong> ₹{currentOrder.finalPrice}
                </p>
                <p>
                ...
                {currentOrder.paymentMethod !== "COD" && (
                  <p className="text-green-600 font-medium">
                    <DollarOutlined className="mr-1" />
                    Full refund will be processed upon cancellation
                  </p>
                )}
                <p>
                  <strong>Items:</strong>{" "}
