...
import { getProfile, changePassword, uploadAvatar } from '../../features/auth/authSlice';
import {
    getAddresses,
    addAddress,
    updateAddress,
...
const ProfilePage = () => {
    ...
    const { user, loading: authLoading, message: authMessage } = useSelector(state => state.auth);
    ...
    const handleDeleteAddress = (index) => {
        Modal.confirm({
            ...
            onOk: async () => {
                try {
                    await dispatch(deleteAddress(index)).unwrap();
                        ...
                        <Card className="text-center shadow-sm sticky top-4">
                            ...
                            <div className="space-y-3 text-left">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">
                                        {addresses?.addresses?.find(addr => addr.isDefault) ? 'Set' : 'Not Set'}
                                    </span>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="shadow-sm">
                            ...
                            >
                                            ...
                                            <Row gutter={16}>
                                                <Col xs={24} md={12}>
                                                    <Form.Item
                                                        name="name"
                                                        label="Full Name"
                                                        rules={[{ required: true, toast: 'Please enter your name' }]}
                                                    >
                                                        <Input
                                ...
                                <TabPane tab="Change Password" key="password">
                                    <div className="max-w-2xl">
                                        <h3 className="text-lg font-semibold mb-6">Update Password</h3>
                                        <Form
                                            form={passwordForm}
                                            layout="vertical"
                                        ...
                                        >
                                            ...
                                            <Form.Item
                                                ...
                                                label="New Password"
                                                rules={[
                                                    { required: true, toast: 'Please enter new password' },
...
const AddressCard = ({ address, index, onEdit, onDelete, onSetDefault }) => {
    return (
        <Card
            className={`border-l-4 ${address.isDefault ? 'border-l-green-500 bg-green-50' : 'border-l-blue-500'
