...
const SearchPage = () => {
  ...
  const { searchResults, isLoading, message, pagination } = useSelector(
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        {/* Error Message */}
        {message && (
          <Alert message={message} type="error" closable className="mb-6" />
        )}
                ...
                <Card>
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-500 max-w-md mx-auto">
                      Enter keywords in the search bar above to find products by
                      name, description, or features.
                    </p>
                  </div>
                </Card>
              </div>
