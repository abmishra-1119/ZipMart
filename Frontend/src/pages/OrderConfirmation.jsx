                    ...
                    <Descriptions bordered column={1}>
                        ...
                        <Descriptions.Item label="Status">
                            <Tag color={
                                currentOrder.status === 'pending' ? 'orange' :
                                    currentOrder.status === 'shipped' ? 'blue' :
                                        currentOrder.status === 'delivered' ? 'green' : 'red'
                            }>
                        ...
                        <Descriptions.Item label="Delivery Address">
                            <div>
                                ...
                                {currentOrder.address.street && <p>{currentOrder.address.street}</p>}
                                {currentOrder.address.landmark && <p>Near {currentOrder.address.landmark}</p>}
